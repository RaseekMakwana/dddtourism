...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ url('admin/diu/pages') }}" type="button" class="btn btn-primary btn-sm">Manage</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ url('admin/diu/pages/update') }}" method="post" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="card-body" style="display: block;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        @if (!empty($data['edit_record']->featured_image) && File::exists(public_path('storage/pages/' . $data['edit_record']->featured_image)))
                                            <img src="{{ asset('storage/pages') . '/' . $data['edit_record']->featured_image }}"

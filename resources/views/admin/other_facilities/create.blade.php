...
@section('title', 'Create | '.$facilities[$segment3])
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ "Create ".$facilities[$segment3] }}</h1>
                </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ url('admin/facilities/'.$segment3.'/store') }}" method="post" enctype="multipart/form-data">
                @csrf

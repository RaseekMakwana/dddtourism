        ...
        "columns": [
            ...
            { 'data': 'created_at' },
            {
                ...
                render: function ( data, type, row ) {
                    var html = '<a href="{{ url("admin/posts/edit") }}/'+row.id+'" class="" ><i class="fas fa-edit"></i></a> | ';
                        html += ' <a href="{{ url("admin/posts/destroy") }}/'+row.id+'" class="text-danger" onclick="return confirm(\'Are you sure you want to delete this record?\');"><i class="fa fa-trash"></i></a>';
                    return html;
                }
            },
        ]

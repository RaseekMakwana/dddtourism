...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ url('admin/video-gallery/update') }}" method="post" enctype="multipart/form-data"
                id="actionForm">
                @csrf
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="hindi_title" id="hindi_title"
                                                value="{{ $edit->hindi_title }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <label>Video Type</label>
                                            <select class="form-control" name="video_type" id="video_type" class="required">
                                                <option value="Video" {{ $edit->type == 'Video' ? 'selected' : '' }}>
                                                    Video</option>
                                                <option value="Shorts" {{ $edit->type == 'Shorts' ? 'selected' : '' }}>
                                                    Shorts</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="youtube_video_url"
                                                id="youtube_video_url" value="{{ $edit->video_url }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="event_date"
                                                max="{{ date('Y-m-d') }}" id="event_date" value="{{ $edit->event_date }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">

...
@section('title', 'Bar And Liquor Shops')
        ...
        <div class="row">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 pb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Bar And Liquor Shops</li>
                </ol>
            </nav>
        </div>
        <div class="row justify-content-center">
            <div class="col-lg-8 mb-5 col-md-11 col-12 title2 mbs text-center">
                <h2>Bar And Liquor Shops</h2>
                ...
                <div class="row">
                    <div class="col-lg-12 btns-green col-md-12 col-12">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link facility_option" data-tab_option='Family Restaurant & Bar' >
                                    Family Restaurant & Bar
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link facility_option" data-tab_option='Bars And Liquor Shops'>
...
function loadMasterData(page = 1){
    ...
    formData.append("facility_type", 'Bars And Liquor Shop');
    formData.append("tab_option", $("#hidden_tab_option").val());
    formData.append("page_number",page);

    axios.post(axios.defaults.baseURL+'site/facilities/bars-and-liquor-shops/get-data', formData).then(function (response) {
        htmlBuilt(response);
...
function htmlBuiltPagination(response){
    ...
    if(meta.total != "0"){
        ...
        $("#facility_total_count_message").text(meta.total+" - Bar And Liquor Shops in {{ ucfirst($segment1) }}");
    } else {

...
@section('title', 'Hotels - Facilities')
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link facility_type" data-tab_option='5 Star' >
                                    5 Star
                                    <span>
                            ...
                            <li class="nav-item">
                                <a class="nav-link facility_type" data-tab_option='Homestay' >
                                    Homestay
                                </a>
                            </li>
                        </ul>
...
function loadMasterData(page = 1){
    ...
    formData.append("facility_type", 'Hotels');
    formData.append("hotel_type", $("#hidden_tab_option").val());
    formData.append("page_number",page);

    axios.post(axios.defaults.baseURL+'site/hotel/get-data', formData).then(function (response) {
        htmlBuilt(response);
                ...
                html += '<figure style="background: url('+element.featured_image+') 50% 50% no-repeat; background-size: cover;">';
                    ...
                    html += '<div class="col-lg-7 rt col-md-7 col-12">';
                        html += '<span class="stars">';
                            if(element.hotel_type == "3 Star"){
                                html += '<img src="{{ url("assets/site/img/star-yellow.png") }}" alt="">';
                                html += '<img src="{{ url("assets/site/img/star-yellow.png") }}" alt="">';
                                html += '<img src="{{ url("assets/site/img/star-yellow.png") }}" alt="">';
                            }
                            if(element.hotel_type == "4 Star"){
                                html += '<img src="{{ url("assets/site/img/star-yellow.png") }}" alt="">';
                                html += '<img src="{{ url("assets/site/img/star-yellow.png") }}" alt="">';
                                html += '<img src="{{ url("assets/site/img/star-yellow.png") }}" alt="">';
                                html += '<img src="{{ url("assets/site/img/star-yellow.png") }}" alt="">';
                            }
                            if(element.hotel_type == "5 Star"){
                                html += '<img src="{{ url("assets/site/img/star-yellow.png") }}" alt="">';
                                html += '<img src="{{ url("assets/site/img/star-yellow.png") }}" alt="">';
                                html += '<img src="{{ url("assets/site/img/star-yellow.png") }}" alt="">';
                                html += '<img src="{{ url("assets/site/img/star-yellow.png") }}" alt="">';
...
function htmlBuiltPagination(response){
    ...
    if(meta.total != "0"){
        ...
        $("#facility_total_count_message").text(meta.total+" - Hotels in {{ ucfirst($segment1) }}");
    } else {

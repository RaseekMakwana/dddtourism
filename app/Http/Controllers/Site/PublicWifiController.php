...
class PublicWifiController extends Controller
{
    ...
    public function index(){
        $data['banner'] = DB::table('banner')->where(['category'=>'Public Wifi','state'=> ucfirst($this->segment1)])->get();
    ...
    public function apiGetMasterData(Request $request){
        ...
        try {
            ...
            $slug = Str::slug(strtolower($inputs['state'].'-public-wifi'));

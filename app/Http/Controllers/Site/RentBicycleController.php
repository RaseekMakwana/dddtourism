...
class RentBicycleController extends Controller
{
    ...
    public function index(){
        $data['banner'] = DB::table('banner')->where(['category'=>'Rent a Bicycle','state'=> ucfirst($this->segment1)])->get();
    ...
    public function apiGetMasterData(Request $request){
        ...
        try {
            ...
            $slug = Str::slug(strtolower($inputs['state'].'-rent-a-bicycle'));

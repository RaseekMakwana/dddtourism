...
class BarsAndLiquorShopsController extends Controller
{
    ...
    public function index(){
        $data['banner'] = DB::table('banner')->where(['category'=>'Bar And Liquor Shops','state'=> ucfirst($this->segment1)])->get();
        $data['facilities_type'] = config('collections.bars_and_liquor_shop_type');
    ...
    public function apiGetMasterData(Request $request){
        ...
        try {
            ...
            $slug = Str::slug(strtolower($inputs['state'].'-bars-and-liquor-shop'));
